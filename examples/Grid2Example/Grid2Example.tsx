...
import { Layout, LayoutPanel, LayoutSplitter, Grid2, Column } from '../../sources/components';
...
export class Grid2Example extends React.Component<{}, CompState> {
    constructor(props: {}) {
        super(props);
        this.state = {
            data: fakeData
        ...
        return (
            <Layout width="100%" height="100%">
                ...
                <LayoutPanel align="client">
                    <Grid2 rowData={this.state.data} fixedColumnCount={2} rowHeight={20} headerHeight={20}>
