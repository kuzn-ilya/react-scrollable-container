    ...
    render(): JSX.Element {
        return (
            <Layout width="100%" height="100%">
                <LayoutPanel align="top" height={50} minHeight={20}>
                    <div className="div-text" style={{backgroundColor: 'yellow'}}>
                    </div>
                </LayoutPanel>
                <LayoutSplitter />
                <LayoutPanel align="right" width={50} minWidth={20}>
                    <div className="div-text" style={{backgroundColor: 'white'}}>
                    </div>
                </LayoutPanel>
                <LayoutSplitter />
                <LayoutPanel align="right" width={60} minWidth={20}>
                    <div className="div-text" style={{backgroundColor: 'lightgray'}}>
                    </div>
                </LayoutPanel>
                <LayoutSplitter />
                <LayoutPanel align="top" height={70} minHeight={20}>
                    <div className="div-text" style={{backgroundColor: 'lightgray'}}>
                    </div>
                </LayoutPanel>
                <LayoutSplitter />
                <LayoutPanel align="left" width={50} minWidth={20}>
                    <div className="div-text" style={{backgroundColor: 'yellow'}}>
                    </div>
                </LayoutPanel>
                <LayoutSplitter />
                <LayoutPanel align="left" width={70} minWidth={20}>
                    <div className="div-text" style={{backgroundColor: 'white'}}>
                    </div>
                </LayoutPanel>
                <LayoutSplitter />
                <LayoutPanel align="bottom" height={100} minHeight={20}>
                    <div className="div-text" style={{backgroundColor: 'yellow'}}>
                    </div>
                </LayoutPanel>
                <LayoutSplitter />
